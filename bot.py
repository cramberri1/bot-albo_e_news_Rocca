...
def parse_albo_html(html: str) -> list:
    ...
    for card in cards:
        ...
        # Una card che dichiara MC02 ma non fornisce identità/riga non è
        # "rumore": è una risposta parziale che non possiamo trattare come sana.
    ...
    if invalid_candidates:
        raise IncompleteAlboSnapshot(
            f"{invalid_candidates} card MC02 prive di titolo o NUMRIGA; snapshot rifiutato"
        )
